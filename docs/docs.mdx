...
- What is composite widgets?
- What does this component do?

https://w3c.github.io/aria/#composite

```
Authors SHOULD ensure that a composite widget exists as a single navigation stop
within the larger navigation system of the web page. Once the composite widget has focus,
authors SHOULD provide a separate navigation mechanism for users to navigate to elements
that are accessibility descendants of the composite element.
```
...
- Demo: Basic vertical list box

## Focus Management

- How focus mananegement works?
...
- Focus keyboard shotcuts

## Selection Management

- How selection mananegement works?
...
- Selection keyboard shotcuts

## Expansion Management

- How expansion mananegement works?
