...
function PolymorphicComposite<T>(props: CompositeProps<T>, ref: ForwardedRef<HTMLDivElement>) {
  const {
    id,
    role,
    navigableChildRole,
        ...
        {items.map((item, index) => {
          ...
          return renderItem(
            ...
            { selected, disabled },
            {
              ...
              className: classes['mantine-Composite-item'],
            },
            index
          );
        })}
...
export const Composite = createPolymorphicComponent<'div', CompositeProps<any>>(
  forwardRef<HTMLDivElement, CompositeProps<any>>(PolymorphicComposite)
);
